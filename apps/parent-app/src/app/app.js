...
function AccountsAppComponent() {
  return (<div class="iframe-wrapper"><iframe src={`${BASE_URL}/accounts`}></iframe></div>);
}
function CustomersAppComponent() {
  return (<div class="iframe-wrapper"><iframe src={`${BASE_URL}/customers`}></iframe></div>);
}
export function App() {
    return (<>
    ...
    <Routes>
      ...
      <Route
        path="/accounts"
        element={<CustomersAppComponent />}
      />
      <Route
        path="/customers"
        element={
          <div style={{width: 500}}><iframe src={`${BASE_URL}/customers`}></iframe></div>
        }
      />
    </Routes>
    {/* END: routes */}
